...
Route::get('/railway/director', 'Railway\RailwayController@director')->name('railway_director_page');
Route::post('/railway/buy_license', 'Railway\LazyTradeController@buyLicense')->name('railway_buy_license_action');
