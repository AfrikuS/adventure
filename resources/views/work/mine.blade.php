...
@section('left_column')
    <ul>
        ...
        <li><a href="/work/process">Работы по обработке ресурсов</a></li>
    </ul>
...
@section('center')
    ...
    <ul>
        <li>Белые шары (лопата, совок)</li>
        <li>Зеленые шары (лопата, совок) (дрель)</li>
        <li>Синие шары (лопата, совок) (агрегат, жидкость)</li>
        <li>Красные шары (лопата, совок) (тележка, белый шар)</li>
        <li>Фиолетовые шары (лопата, совок) (навык под добыче шаров > 38)</li>
        <li>Черные шары (лопата, совок) (добывается экспериментальным путем, вероятность добычи 33%, навык > 70%)</li>
    </ul>
    <p>
    ...
    <p>
    <ul>
        <li>Single_work - разовая работа для одного (нименьшая отдача)</li>
        <li>Single_teamwork - разовая работа для нескольких участников под началом опытного лидера</li>
        <li>private_teamwork - закрытая группа из нескольких человек без опытного лидера, состав участников задается заранее и не меняется</li>
        <li>open_teamwork -есть ядро постоянных участников, но есть возможность разовых включений (приглашений) для других людей (1-3 чел.)</li>
        <li>full_teamwork - У тимворка есть 1 владелец. Остальные могут быть партнерами\постоянными или разовыми,
            владелец может менять статус участника, рассылать приглашения и тп. фулл-контроль. todo продумать!</li>
    </ul>
    <p>
